...
# $NPFP$ results and download

The result of the pathway model is a dataframe with the estimated number of founder populations ($NPFP$) for each country of interest i.
Below, the table below displays the $NPFP$ results at `r NUTS_lev` level. 
...
The map shows the median $NPFP$ values by `r NUTS_lev`.
...
```
Figure 1: $NPFP$ values redistributed at the `r NUTS_lev` level.
