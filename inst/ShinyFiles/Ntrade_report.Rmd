...
When uploading the datasets to calculate $N_{trade}$, the selected unit was: `r units` 
...
if(length(population_year)==1){
  ...
  population_year_text <- paste0("years for population data are the average of the ", population_year, " years")
}
...
#Please, remove "#" once the column names of the dataset have been revised
...
$N_{trade}$ data were redistributed from NUTS0 to NUTS2 level proportionally to `r data_text`.
